...
const employeesBonus = (arr) => {
    arr.forEach(element => {
        if(element.section=='Production' || element.workHours>8){
            element.salary=Number(element.salary.substring(0,4))+100+'$';
        }
        else{
            element.salary=Number(element.salary.substring(0,4))+50+'$';
        }
